...
export const Activity = (properties: ActivityProperties) => (
  <section {...properties}>
    <Container className="flex flex-col gap-8 border-x px-4 pt-16 pb-4">
      ...
      <div className="grid gap-4 md:grid-cols-6">
        <Card
          ...
          description="Hir3d keeps a log of all activity across your product team, from new features to portal updates."
        >
          <ActivityGraphic />
        </Card>
        {/* <Card
    ...
    title="What's new?"
    description="Hir3d takes your team's activity and summarizes it into a digestible format, so you can stay in sync."
    badge="Coming soon"
  >
    <DigestGraphic />
  </Card>
  ...
  >
    <TrendsGraphic />
        ...
        <Card
          ...
          description="Get a real-time view of who's on Hir3d and what they're working on."
        >
          <PresenceGraphic />
        </Card>
      </div>
